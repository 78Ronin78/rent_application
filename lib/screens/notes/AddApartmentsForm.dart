...
class AddApartmentsForm extends StatefulWidget {
  const AddApartmentsForm({Key? key}) : super(key: key);

  @override
  State<AddApartmentsForm> createState() => _AddApartmentsFormState();
}
  ...
  Widget build(BuildContext context) {
    ...
    void _validateHomePhoneData() async {
      ...
      if (formKey.currentState!.validate()) {
        form!.save();
        FirestoreService.addHomePhone(_address, _number);
