...
Map<int, Color> color = {
  50: const Color.fromARGB(23, 74, 77, 244),
  100: const Color.fromARGB(51, 74, 142, 244),
  200: const Color.fromARGB(75, 74, 105, 244),
  300: const Color.fromARGB(102, 74, 114, 244),
  400: const Color.fromARGB(125, 0, 50, 189),
  500: const Color.fromARGB(255, 0, 98, 211),
  600: const Color.fromARGB(255, 0, 119, 255),
  700: const Color.fromARGB(255, 33, 137, 255),
  800: const Color.fromARGB(255, 57, 149, 255),
  900: const Color.fromARGB(255, 74, 159, 255),
};

var customizedTheme = ThemeData(
  canvasColor: Colors.grey,
  primaryColor: const Color.fromARGB(255, 0, 110, 255),
  primaryColorLight:
      const Color.fromARGB(255, 67, 151, 246), // Color(0xFF66d5ff),

  primaryColorDark: const Color.fromARGB(255, 0, 4, 255),
  ...
  primaryTextTheme: const TextTheme(
    ...
    headline6:
        TextStyle(fontSize: 18, color: Colors.white), // home's card title
    button: TextStyle(
      fontSize: 10,
...
// home's card title,
  ...
  dividerTheme: DividerThemeData(
      color: Color(0xFFEDF2F6).withOpacity(0.5), thickness: 1.5),
  ...
  inputDecorationTheme: InputDecorationTheme(
    ...
    iconColor: Color.fromARGB(255, 199, 16, 3),
    filled: true,
...
ThemeData nativeTheme({required bool isDarkModeEnable}) {
  if (isDarkModeEnable) {
    Map<int, Color> color = {
      50: Color.fromARGB(23, 74, 77, 244),
      100: Color.fromARGB(51, 74, 142, 244),
      200: Color.fromARGB(75, 74, 105, 244),
      300: Color.fromARGB(102, 74, 114, 244),
      400: Color.fromARGB(125, 0, 50, 189),
      500: Color.fromARGB(255, 0, 98, 211),
      600: Color.fromARGB(255, 0, 119, 255),
      700: Color.fromARGB(255, 33, 137, 255),
      800: Color.fromARGB(255, 57, 149, 255),
      900: Color.fromARGB(255, 74, 159, 255),
    };
    return ThemeData(
      canvasColor: Color.fromARGB(255, 39, 39, 39),
      primaryColor: Color.fromARGB(255, 0, 110, 255),
      primaryColorLight:
          Color.fromARGB(255, 255, 255, 255), // Color(0xFF66d5ff),
      primaryColorDark: Color.fromARGB(255, 0, 0, 0),
      primarySwatch: MaterialColor(0xFFF4694A, color),
      primaryIconTheme: IconThemeData(color: Colors.white),
      //iconTheme: IconThemeData(color: Colors.white),
      iconTheme: IconThemeData(color: Color(0xFF9EA5A8)),
      primaryTextTheme: TextTheme(
        ...
        headline3: TextStyle(
            ...
            letterSpacing: 0.5), // title
        headline4:
            TextStyle(color: Colors.white70, fontSize: 17), //login,otp subtitle
        headline5: TextStyle(
            color: Colors.white,
            fontSize: 18,
            fontWeight: FontWeight.w500,
            letterSpacing: 0.3,
            fontFamily: 'PoppinsMedium'), //home titles
        headline6:
            TextStyle(fontSize: 18, color: Colors.white), // home's card title
        button: TextStyle(
            fontSize: 10,
        ...
        subtitle1: TextStyle(
            ...
            color: Color(0xFF332E38),
            fontWeight: FontWeight.w500,
            fontFamily: 'PoppinsMedium'), //home screen
        subtitle2: TextStyle(
            fontSize: 12,
            color: Color(0xFF332E38),
            fontWeight: FontWeight.w300,
            fontFamily: 'PoppinsLight'), //home screen
        bodyText1: TextStyle(
            fontSize: 14,
            color: Colors.white,
            fontWeight: FontWeight.w500,
    ...
    return ThemeData(
      ...
      primaryColorLight: Colors.white, // Color(0xFF66d5ff),
      ...
      primaryTextTheme: TextTheme(
        ...
        headline2: TextStyle(
            ...
            color: Color(0xFF9EA5A8),
            fontWeight: FontWeight.w400,
            fontFamily: 'PoppinsRegular'), //home subtitle
        headline3: TextStyle(
            fontSize: 24,
            color: Colors.white,
            fontWeight: FontWeight.bold,
        ...
        headline6: TextStyle(
            fontSize: 18,
            color: Colors.black,
            fontWeight: FontWeight.w600), // home's card title
        button: TextStyle(
            fontSize: 10,
            color: Color(0xFF41505B),
            fontWeight: FontWeight.w400,
            fontFamily: 'PoppinsRegular'),
        subtitle1: TextStyle(
            fontSize: 14,
      ...
      bottomSheetTheme:
          BottomSheetThemeData(backgroundColor: Color(0xFF5c7de0)),
      cardTheme: CardTheme(
        elevation: 0.5,
        margin: EdgeInsets.all(0),
